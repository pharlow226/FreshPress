...
import { X, ChevronDown, ChevronUp, Trash2, Copy, Check, Send } from "lucide-react";
    ...
    return (
      <div className={`flex ${isUser ? "justify-end" : "justify-start"} mb-3`}>
        ...
        <div className={`max-w-[80%] flex flex-col ${isUser ? "items-end" : "items-start"}`}>
          <div className={`px-4 py-2.5 text-sm leading-relaxed whitespace-pre-wrap break-words [overflow-wrap:anywhere] select-text ${isUser ? "bg-gradient-to-br from-[hsl(var(--brand-gradient-via))] to-[hsl(var(--brand-gradient-to))] text-white font-medium rounded-2xl rounded-br-sm" : "bg-secondary text-foreground rounded-2xl rounded-bl-sm"}`}>
