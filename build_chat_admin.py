...
sidebar_path = r'src\routes\admin\components\AdminSidebar.tsx'
...
dashboard_path = r'src\routes\admin\AdminDashboard.tsx'
...
# 3. Create ChatLogsPage.tsx
chatlogs_code = """import { useState, useEffect } from 'react';
...
with open(r'src\routes\admin\components\ChatLogsPage.tsx', 'w', encoding='utf-8') as f:
    f.write(chatlogs_code)
